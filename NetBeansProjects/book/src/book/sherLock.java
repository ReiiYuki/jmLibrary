...
public class sherLock extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/book/pic/SherL2.jpg"))); // NOI18N
        ...
        jTextArea2.setText("Name         :\tSherlock Holmes\n\nAuthor       :\tSir Arthur Conan Doyle\nCountry     :\tUnited States\nLanguage   :\tEnglish\n\nintroduction \nDetails about Sherlock Holmes's life, except for the adventures in the books,\n are scarce in Conan Doyle's original stories. Nevertheless, mentions of his early life \nand extended family paint a loose biog.");
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        try {
            if(Book.findBook(Book.readBook(),name)) {
                ...
                myB.setVisible(true);
                myB.setTextlist("Sherlock Holmes\n");
            }
        } catch (IOException ex) {
            Logger.getLogger(sherLock.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
           if(Book.findBook(Book.readBook(), name)){
                 ...
                 myBook myB = new myBook();
                 myB.setVisible(true);
            myB.reTextList("return Sherlock Holmes\n");
           } else {
